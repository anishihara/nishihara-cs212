...
def bridge_problem3(here):
    ...
    mygoal = lambda x : x == (frozenset([]),frozenset(here + ['light']))
    return lowest_cost_search((frozenset(here + ['light']),frozenset([])),bsuccessors2,mygoal,bcost) # <== your arguments here
