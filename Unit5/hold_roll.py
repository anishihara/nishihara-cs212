...
def hold(state):
    ...
    # your code here
    p,player0,player1,pending = state
    if p is 0:
        p = 1
    else:
        p = 0
    return (p,player1,player0+pending,0)
...
def roll(state, d):
    ...
    # your code here
    p,player0,player1,pending = state
    return (p,player0,player1,pending+d) if d is not 1 else (0,player1,player0+1,0) if p is 1 else (1,player1,player0+1,0)
